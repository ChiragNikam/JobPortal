...
fun CompanyProfile(){
    Column(horizontalAlignment = Alignment.Start) {
        var selectedState by remember { // to remember which button is clicked(Create Company or Company) and showing UI accordingly
            mutableStateOf(0)
        }
...
fun CompanyDetails(){
    ...
    Column(horizontalAlignment = Alignment.Start) {
        ...
        Spacer(modifier = Modifier.height(24.dp))
        BtnCustom(onClicking = { /*TODO*/ }, text = "Remove Company", padStart = 0, padEnd = 152)
